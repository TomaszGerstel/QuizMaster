...
class QuizEvaluationServiceTest extends Specification {
    ...
    static AttemptToEvalDTO quiz1 = new AttemptToEvalDTO(
            ...
            List.of(
                    new EvalQuestion(question1id, type, scoringStrategy, "some explanation", List.of(new EvalAnswer(1, false), new EvalAnswer(2, true)), null, null),
                    new EvalQuestion(question2id, type, scoringStrategy, "some explanation 2", List.of(new EvalAnswer(1, true), new EvalAnswer(2, false)), null, null)
            ))

    static AttemptToEvalDTO quiz2 = new AttemptToEvalDTO(
            "session124", "email2", quiz2id, Instant.now().minusSeconds(30), 65,
            List.of(
                    new EvalQuestion(question3id, type, scoringStrategy, "explanation 3", List.of(new EvalAnswer(1, true), new EvalAnswer(2, false), new EvalAnswer(3, true)), null, null),
                    new EvalQuestion(question4id, type, scoringStrategy, "", List.of(new EvalAnswer(1, false), new EvalAnswer(2, true), new EvalAnswer(3, false)), null, null),
                    new EvalQuestion(question5id, type, scoringStrategy, "", List.of(new EvalAnswer(1, true), new EvalAnswer(2, false)), null, null)
            ))
    ...
    def "should eval properly quiz solution"() {
        ...
        quiz1    | List.of(solution(question1id, List.of(2)), solution(question2id, List.of(1)))                                          | true        | 2        | 2         | [answerReport(question1id, [2], "some explanation", true), answerReport(question2id, [1], "some explanation 2", true)]                           | "2/2 correct answers"
        quiz1    | List.of(solution(question1id, List.of(1)), solution(question2id, List.of(1)))                                          | false       | 1        | 2         | [answerReport(question1id, [2], "some explanation", false), answerReport(question2id, [1], "some explanation 2", true)]                          | "1/2 correct answers"
        quiz1    | List.of(solution(question1id, List.of(1)), solution(question2id, List.of(3)))                                          | false       | 0        | 2         | [answerReport(question1id, [2], "some explanation", false), answerReport(question2id, [1], "some explanation 2", false)]                         | "0/2 correct answers"
        quiz2    | List.of(solution(question3id, List.of(1, 3)), solution(question4id, List.of(2)), solution(question5id, List.of(1)))    | true        | 3        | 3         | [answerReport(question3id, [1, 3], "explanation 3", true), answerReport(question4id, [2], "", true), answerReport(question5id, [1], "", true)]   | "3/3 with multi answer question"
        quiz2    | List.of(solution(question3id, List.of(1)), solution(question4id, List.of(2)), solution(question5id, List.of(1)))       | true        | 2        | 3         | [answerReport(question3id, [1, 3], "explanation 3", false), answerReport(question4id, [2], "", true), answerReport(question5id, [1], "", true)]  | "2/3 with wrong answer for multi answer question"
        ...
        quiz2    | List.of(solution(question3id, List.of(1, 3)), solution(question4id, List.of(2, 3)), solution(question5id, List.of(6))) | false       | 1        | 3         | [answerReport(question3id, [1, 3], "explanation 3", true), answerReport(question4id, [2], "", false), answerReport(question5id, [1], "", false)] | "1/3 as negative"
    }
    ...
    def "should throw exception for not existing quiz"() {
        ...
        def quizId = quiz2id
        def sessionId = "session123"
        def command = new SubmitQuizCommand(List.of(solution("deadbeefcafebabe12345901", List.of(2))), sessionId)
    ...
    def "should throw exception for not related question to given quiz"() {
        ...
        def sessionId = "session123"
        def solutions = List.of(solution("cafebeefdeadbead12345001", List.of(2)), solution(wrongQuestionId, List.of(2)))
    ...
    private static QuestionSolution solution(String questionId, List<Integer> answerIds) {
        return new QuestionSolution(questionId, Question.Type.MULTIPLE_CHOICE, answerIds, null, null, null, null)
    }
